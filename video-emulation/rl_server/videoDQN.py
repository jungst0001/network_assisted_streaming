...
OLD_MODEL_NAME1 = ['model_03_40_02','model_03_40_03','model_03_30_04', \
    'model_03_25_05', 'model_03_20_06', 'model_03_20_07', 'model_03_20_08', 'model_03_45_09']
OLD_MODEL_NAME2 = ['model_04_45_01', 'model_04_25_02', 'model_04_28_02', 'model_04_27_04', \
    'model_04_26_05', 'model_04_30_06', 'model_04_29_07', 'model_04_28_08', \
    'model_04_28_09', 'model_04_28_10', 'model_04_28_11', 'model_04_28_12', 'model_04_28_13', \
    'model_04_28_14']
OLD_MODEL_NAME2 = ['model_05_28_01', 'model_05_28_02', 'model_05_28_03', 'model_05_28_04', 'model_05_28_05', \
    'model_05_28_06']
# name first: version / second: hidden size / third: minor-version
OLE_MODEL_NAME4 = ['model_06_28_01', 'model_06_28_02', 'model_06_28_03', 'model_06_28_04']
MODEL_NAME = ['model_07_28_01', 'model_07_28_02', 'model_07_28_03', 'model_07_28_04', 'model_07_28_05']
# MODEL model_06_28_03 is a default
# subDir of  MODEL 06 is 'set3+4/'
...
def replay_train(mainDQN: dqn.DQN, targetDQN: dqn.DQN, train_batch: list) -> float:
    ...
    # print(f'Q_pred is: {DISCOUNT_RATE * np.max(targetDQN.predict(next_states), axis=1)}')
    # print(f'rewards is: {rewards[0]}')
    # print(f'Q_target is: {Q_target[0]}')
...
def train_dqn_model(h_size=50):
    ...
    with tf.device("/gpu:0"):
        with tf.compat.v1.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            mainDQN = dqn.DQN(sess, INPUT_SIZE, OUTPUT_SIZE, name="main", h_size=h_size)
            targetDQN = dqn.DQN(sess, INPUT_SIZE, OUTPUT_SIZE, name="target", h_size=h_size)
...
def load_model(sess: tf.compat.v1.Session, model_index):
    ...
    predDQN = dqn.DQN(sess, INPUT_SIZE, OUTPUT_SIZE, name="pred", h_size=h_size)
    copy_ops = get_copy_var_ops(dest_scope_name="pred", src_scope_name="target")
    sess.run(copy_ops)

    return predDQN

def test_saved_model(modelDQN: dqn.DQN=None, model_index=0):
